...
class GoogleLoginView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            # Look up user by email (prevents duplicate accounts)
            ...
            if user is None:
                user = User.objects.create_user(
                    ...
                    email=email,
                    first_name=name or "",
                    password=None,  # Google users authenticate via Firebase, not a local password
                )
            else:
            ...
            # Issue JWT tokens for your own API auth
            refresh = RefreshToken.for_user(user)
